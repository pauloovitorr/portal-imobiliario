      ...
      <aside class="gaveta-mobile">
        <div class="gaveta-header">
          ...
          <NuxtLink to="/" class="navbar-logo">
            <div class="logo-icon">
              <NuxtImg src="/meulugar.png" width="200px" alt="Logo do portal imobiliário" format="webp"
                loading="lazy" />
            </div>
          </NuxtLink>
        ...
        <div class="gaveta-conteudo">
          <nav class="nav-mobile-menu">
            ...
            <div class="nav-mobile-item">
              <button class="nav-mobile-trigger" :class="{ 'is-open': openSubmenu === 'comprar' }"
                @click="toggleSubmenu('comprar')">
                <span>Comprar</span>
                <ChevronDown class="icon-arrow" />
              </button>

              <div class="accordion-wrapper" :class="{ 'is-expanded': openSubmenu === 'comprar' }">
            ...
            <div class="nav-mobile-item">
              <button class="nav-mobile-trigger" :class="{ 'is-open': openSubmenu === 'alugar' }"
                @click="toggleSubmenu('alugar')">
                <span>Alugar</span>
                <ChevronDown class="icon-arrow" />
              </button>

              <div class="accordion-wrapper" :class="{ 'is-expanded': openSubmenu === 'alugar' }">
                <div class="submenu-mobile">
                  <a href="#" class="submenu-link" @click="handleClose">Apartamentos</a>
                  <a href="#" class="submenu-link" @click="handleClose">Casas</a>
