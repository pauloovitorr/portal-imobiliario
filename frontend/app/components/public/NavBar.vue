...
// Controle do estado do menu mobile
...
<template>
  <header class="navbar-header">
    <PublicMenuDesktop :isMenuOpen="isMenuOpen" @toggle-menu="toggleMenu" />
    <PublicMenuMobile :isMenuOpen="isMenuOpen" @close-menu="toggleMenu" />
  </header>
</template>
